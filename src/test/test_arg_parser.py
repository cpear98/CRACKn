...
class TestArgParser(unittest.TestCase):
    # Test ArgParser.parse_cli method
    def test_parse_cli_exits_with_no_args(self):
        args = []
        parser = ArgParser(args, check_assertions=True)
    ...
    # Test ArgParser.parse_param method
    def test_parse_param(self):
        pass

    # Test ArgParser.parse_flag method
    def test_parse_flag(self):
        pass

    # Test ArgParser.has_basic_requirements method
    def test_has_basic_requirements(self):
        pass

    # Test ArgParser.is_valid_flag method
    def test_is_valid_flag(self):
        pass

    # Test ArgParser.is_valid_param method
